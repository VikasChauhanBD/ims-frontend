...
export const inventoryAPI = {
  ...
  markMaintenance: (id) => api.post(`/inventory/devices/${id}/mark_maintenance/`),
  ...
  updateAssignment: (id, data) => api.patch(`/inventory/assignments/${id}/`, data),
  deleteAssignment: (id) => api.delete(`/inventory/assignments/${id}/`),
  returnDevice: (id, notes) => api.post(`/inventory/assignments/${id}/return_device/`, { return_notes: notes }),
  ...
  assignTicket: (id, employeeId) => api.post(`/inventory/tickets/${id}/assign/`, { assigned_to: employeeId }),
  resolveTicket: (id, notes) => api.post(`/inventory/tickets/${id}/resolve/`, { resolution_notes: notes }),
